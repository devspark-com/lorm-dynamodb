...
public class BaseIntegrationTest {
    ...
    private static final String ACCESS_KEY = System.getProperty("dynamodb.user.access");
    private static final String SECRET_KEY = System.getProperty("dynamodb.user.secret");
	...
	entityManager = new DynamoDBEntityManager(HOST, PORT, ACCESS_KEY, SECRET_KEY);
	...
	EntityToItemMapper entityToItemMapper = new EntityToItemMapperImpl<T>(entityClass);
	EntitySchemaSupport entitySchemaSupport = new EntityToItemMapperImpl<T>(entityClass);
	ItemToEntityMapper<T> itemToEntityMapper = new ItemToEntityMapperImpl<T>(entityClass,
		entityManager);
	...
	SchemaSupport<T> repository = (SchemaSupport<T>) entityManager.getRepository(entityClass);
